...
- 문제·페르소나·가치·solution scope·Full PRD 협업: `prd-flow`
- 확정 PRD의 설계·구현·테스트: `ai-dlc`
- 정답표·기계 지표가 있는 핵심 가설 최적화: `loop-harness`
- 통합 MVP의 정밀 UX 진단: `ux-researcher`
- 독립 work package의 별도 Codex CLI 실행: `codex-delegate`
